...
from outhad_contextkit.memory.setup import get_or_create_user_id
...
if not isinstance(OUTHAD_CONTEXTKIT_TELEMETRY, bool):
    raise ValueError("OUTHAD_CONTEXTKIT_TELEMETRY must be a boolean value.")
...
class AnonymousTelemetry:
    def __init__(self, vector_store=None):
        ...
        if not OUTHAD_CONTEXTKIT_TELEMETRY:
    ...
    def capture_event(self, event_name, properties=None, user_email=None):
        ...
        properties = {
            ...
            "client_version": outhad_contextkit.__version__,
