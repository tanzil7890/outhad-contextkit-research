...
class MongoDBConfig(BaseModel):
    ...
    db_name: str = Field("outhad_contextkit_db", description="Name of the MongoDB database")
    collection_name: str = Field("outhad_contextkit", description="Name of the MongoDB collection")
