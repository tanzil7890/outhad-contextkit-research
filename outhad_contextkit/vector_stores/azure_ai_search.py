...
from outhad_contextkit.memory.utils import extract_json
from outhad_contextkit.vector_stores.base import VectorStoreBase
...
class AzureAISearch(VectorStoreBase):
    def __init__(
        ...
        self.search_client._client._config.user_agent_policy.add_user_agent("outhad_contextkit")
        self.index_client._client._config.user_agent_policy.add_user_agent("outhad_contextkit")
