...
from outhad_contextkit.configs.vector_stores.azure_ai_search import AzureAISearchConfig

# Import the AzureAISearch class and related models
from outhad_contextkit.vector_stores.azure_ai_search import AzureAISearch
...
def mock_clients():
    with (
        patch("outhad_contextkit.vector_stores.azure_ai_search.SearchClient") as MockSearchClient,
        patch("outhad_contextkit.vector_stores.azure_ai_search.SearchIndexClient") as MockIndexClient,
        patch("outhad_contextkit.vector_stores.azure_ai_search.AzureKeyCredential") as MockAzureKeyCredential,
    ):
...
def test_config_validation_valid():
    ...
    assert config.collection_name == "outhad_contextkit"  # Default value
...
def test_initialization(mock_clients):
    ...
    assert "outhad_contextkit" in mock_search_client._client._config.user_agent_policy.add_user_agent.call_args[0]
    assert "outhad_contextkit" in mock_index_client._client._config.user_agent_policy.add_user_agent.call_args[0]
