...
from outhad_contextkit.vector_stores.elasticsearch import ElasticsearchDB, OutputData
...
class TestElasticsearchDB(unittest.TestCase):
    ...
    def setUp(self):
        ...
        patcher = patch("outhad_contextkit.vector_stores.elasticsearch.Elasticsearch", return_value=self.client_mock)
    ...
    def test_insert(self):
        ...
        # Mock bulk operation
        with patch("outhad_contextkit.vector_stores.elasticsearch.bulk") as mock_bulk:
