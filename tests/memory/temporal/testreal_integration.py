"""Real integration tests for  LoCoMo Evaluation."""
import os
import json
import logging
...
def test_locomo_baseline():
    """Test LoCoMo evaluation with baseline (no TCMGM)."""
    logger.info("\n" + "="*80)
    logger.info("REAL INTEGRATION TEST: Baseline Evaluation")
    logger.info("="*80)
    ...
    try:
        ...
        config = MemoryConfig(custom_storage_path="test_baseline.db")
        ...
        logger.info("\n" + "="*80)
        logger.info("🎉 BASELINE EVALUATION PASSED! 🎉")
        logger.info("="*80)
        logger.info("\nTest Summary:")
...
def test_locomo_tcmgm():
    """Test LoCoMo evaluation with TCMGM."""
    logger.info("\n" + "="*80)
    logger.info("REAL INTEGRATION TEST: TCMGM Evaluation")
    logger.info("="*80)
    ...
    try:
        ...
        config = MemoryConfig(
            custom_storage_path="test_tcmgm.db",
        ...
        logger.info("\n" + "="*80)
        logger.info("🎉 TCMGM EVALUATION PASSED! 🎉")
        logger.info("="*80)
        logger.info("\nTest Summary:")
...
if __name__ == "__main__":
    ...
    # Test baseline
    if not test_locomo_baseline():
        all_passed = False
    
    # Test TCMGM
    if not test_locomo_tcmgm():
        all_passed = False
