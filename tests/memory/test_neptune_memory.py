...
from outhad_contextkit.graphs.neptune.base import NeptuneBase
...
class TestNeptuneMemory(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.neptune_analytics_graph_patcher = patch("outhad_contextkit.graphs.neptune.main.NeptuneAnalyticsGraph")
    ...
    def test_search_method(self):
        ...
        # Mock BM25Okapi
        with patch("outhad_contextkit.graphs.neptune.base.BM25Okapi") as mock_bm25:
