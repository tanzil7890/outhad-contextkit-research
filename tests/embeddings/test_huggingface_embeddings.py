...
from outhad_contextkit.embeddings.huggingface import HuggingFaceEmbedding


@pytest.fixture
def mock_sentence_transformer():
    with patch("outhad_contextkit.embeddings.huggingface.SentenceTransformer") as mock_transformer:
        mock_model = Mock()
