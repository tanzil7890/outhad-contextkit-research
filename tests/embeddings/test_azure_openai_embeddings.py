...
from outhad_contextkit.embeddings.azure_openai import AzureOpenAIEmbedding


@pytest.fixture
def mock_openai_client():
    with patch("outhad_contextkit.embeddings.azure_openai.AzureOpenAI") as mock_openai:
        mock_client = Mock()
